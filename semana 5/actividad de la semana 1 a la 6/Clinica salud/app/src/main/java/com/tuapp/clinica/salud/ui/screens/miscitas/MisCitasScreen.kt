package com.tuapp.clinica.salud.ui.screens.miscitas
...
fun MisCitasScreen(
    ...
    Scaffold(
        ...
        if (SampleData.citasAgendadas.isEmpty()) {
            Box(
                modifier = Modifier
                    .fillMaxSize()
            ...
            LazyColumn(
                ...
                items(
                    items = SampleData.citasAgendadas,
                    key = { cita -> "${cita.medico}-${cita.fecha}-${cita.hora}" }
                ) { cita ->
                    CitaCard(
                        cita = cita,
                        onCancelar = {
        ...
        if (citaACancelar != null) {
            AlertDialog(
                ...
                text = { Text("¿Deseas cancelar esta cita?") },
                confirmButton = {
                    TextButton(
                        onClick = {
